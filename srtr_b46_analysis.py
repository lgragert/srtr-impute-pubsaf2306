...
tx_ki = tx_ki[['ORG_TY','PERS_ID','DONOR_ID','PX_ID','CAN_LISTING_DT','REC_TX_DT', 'REC_HISTO_TX_ID', 'REC_TX_TY',\
		'DON_TY','DON_ABO','DON_RACE','DON_RACE_SRTR','DON_ETHNICITY_SRTR','DON_A1','DON_A2','DON_B1','DON_B2','DON_DR1','DON_DR2', \
		'REC_AGE_IN_MONTHS_AT_TX','CAN_ABO','CAN_RACE','CAN_RACE_SRTR','CAN_ETHNICITY_SRTR','REC_A1','REC_A2','REC_B1','REC_B2','REC_DR1','REC_DR2',
		'REC_A_MM_EQUIV_CUR','REC_B_MM_EQUIV_CUR','REC_DR_MM_EQUIV_CUR','CAN_LAST_SRTR_PEAK_PRA']]
...
# remove colons from blood group
tx_ki_all_hla.DON_ABO = tx_ki_all_hla.DON_ABO.str.split(': ',expand=True)[1]
tx_ki_all_hla.CAN_ABO = tx_ki_all_hla.CAN_ABO.str.split(': ',expand=True)[1]
# tx_ki_all_hla.loc[tx_ki_all_hla["DON_ABO"] == "A1", "DON_ABO"] = "A"
# tx_ki_all_hla.loc[tx_ki_all_hla["DON_ABO"] == "A2", "DON_ABO"] = "A"
# tx_ki_all_hla.loc[tx_ki_all_hla["DON_ABO"] == "A1B", "DON_ABO"] = "A"
# tx_ki_all_hla.loc[tx_ki_all_hla["DON_ABO"] == "A2B", "DON_ABO"] = "A"
# tx_ki_all_hla.loc[tx_ki_all_hla["CAN_ABO"] == "A1", "CAN_ABO"] = "A"
# tx_ki_all_hla.loc[tx_ki_all_hla["CAN_ABO"] == "A2", "CAN_ABO"] = "A"
# tx_ki_all_hla.loc[tx_ki_all_hla["CAN_ABO"] == "A1B", "CAN_ABO"] = "A"
# tx_ki_all_hla.loc[tx_ki_all_hla["CAN_ABO"] == "A2B", "CAN_ABO"] = "A"


# drop extra columns
tx_ki_all_hla = tx_ki_all_hla.drop(columns=["ORG_TY","PERS_ID","REC_HISTO_TX_ID","REC_TX_TY","DON_TY","DON_ETHNICITY_SRTR","REC_AGE_IN_MONTHS_AT_TX","CAN_ETHNICITY_SRTR",\
			"DON_C1","DON_C2","DON_DQ1","DON_DQ2","DON_DP1","DON_DP2","DON_DR51","DON_DR52","DON_DR53",\
			"REC_CW1","REC_CW2","REC_DQW1","REC_DQW2","REC_DPW1","REC_DPW2","REC_DRW51","REC_DRW52","REC_DRW53",\
			"DON_DRB3_1","DON_DRB3_2","DON_DRB4_1","DON_DRB4_2","DON_DRB5_1","DON_DRB5_2","DON_DQA1","DON_DQA2",\
			"DON_DPA1","DON_DPA2","REC_DRB3_1","REC_DRB3_2","REC_DRB4_1","REC_DRB4_2","REC_DRB5_1","REC_DRB5_2","REC_DQA1","REC_DQA2",
			"REC_DPA1","REC_DPA2"])
...
tx_ki_b46_donor = tx_ki_all_hla.loc[((tx_ki_all_hla['DON_B1'] == '46') & (tx_ki_all_hla['DON_B2'] == '46')) | 
									((tx_ki_all_hla['DON_B1'] == '46') & (tx_ki_all_hla['DON_B2'] == '')) |
									((tx_ki_all_hla['DON_B1'] == '73') & (tx_ki_all_hla['DON_B2'] == '73')) |
									((tx_ki_all_hla['DON_B1'] == '73') & (tx_ki_all_hla['DON_B2'] == '')) |
									((tx_ki_all_hla['DON_B1'] == '46') & (tx_ki_all_hla['DON_B2'] == '73')) |
									((tx_ki_all_hla['DON_B1'] == '73') & (tx_ki_all_hla['DON_B2'] == '46'))
									]

# indicator variable for B46 homozygous recip
tx_ki_b46_donor.loc[:,'B46_HOMOZ_RECIP'] = (((tx_ki_b46_donor['REC_B1'] == '46') & (tx_ki_b46_donor['REC_B2'] == '46')) | ((tx_ki_b46_donor['REC_B1'] == '46') & (tx_ki_b46_donor['REC_B2'] == '')))
# tx_ki_b46_donor['B46_HOMOZ_RECIP'] = "FALSE"
# tx_ki_b46_donor.loc[((tx_ki_b46_donor['REC_B1'] == '46') & (tx_ki_b46_donor['REC_B2'] == '46') |  (tx_ki_b46_donor['REC_B1'] == '46') & (tx_ki_b46_donor['REC_B2'] == '')), 'B46_HOMOZ_RECIP'] = "TRUE"

# indicator variable of 0-ABDR AgMM
tx_ki_b46_donor.loc[:,'ZERO_ABDR_AGMM'] = ((tx_ki_b46_donor['REC_A_MM_EQUIV_CUR'] == "0") & (tx_ki_b46_donor['REC_B_MM_EQUIV_CUR'] == "0") & (tx_ki_b46_donor['REC_DR_MM_EQUIV_CUR'] == "0"))

# indicator variable for CPRA=100
# CAN_LAST_SRTR_PEAK_PRA - max of cand, pra_hist, rec_histo
tx_ki_b46_donor.loc[:,'CPRA_100'] = ((tx_ki_b46_donor['CAN_LAST_SRTR_PEAK_PRA'] == "100"))


# indicator variable for nonpermissible blood type
# OPTN Policies Table 8-6: Allocation of Kidneys by Blood Type

# Kidneys from Donors with: Blood Type O 
# Are Allocated to Candidates with: Blood type O.
# For offers made to candidates in 0-ABDR mismatch categories, blood type O kidneys may be 
# transplanted into candidates who have blood types other than O.

# Kidneys from Donors with: Blood Type A
# Are Allocated to Candidates with: Blood type A or blood type AB.

# Kidneys from Donors with: Blood Type B 
# Are Allocated to Candidates with: Blood type B.
# For offers made to candidates in 0-ABDR mismatch categories, blood type B kidneys may be 
# transplanted into candidates who have blood types other than B.

# Kidneys from Donors with: Blood Type AB
# Are Allocated to Candidates with: Blood type AB.

# Kidneys from Donors with: Blood Types A, non-A1 and AB, non-A1B
# Are Allocated to Candidates with: Kidneys may be transplanted into candidates with blood type B 
# who meet all of the following criteria:
# 1. The transplant program obtains written informed consent from each blood type B candidate 
# regarding their willingness to accept a blood type A, non-A1 or blood type AB, non-A1B blood type kidney.
# 2. The transplant program establishes a written policy regarding its program’s titer threshold 
# for transplanting blood type A, non-A1 and blood type AB, non-A1B kidneys into candidates with 
# blood type B. The transplant program must confirm the candidate’s eligibility every 90 days (+/- 20 days).

tx_ki_b46_donor.loc[:,'ABO_NONPERMISSABLE'] = \
	(((tx_ki_b46_donor['DON_ABO'] == "O") & (tx_ki_b46_donor['CAN_ABO'] != "O")) | 
	((tx_ki_b46_donor['DON_ABO'] == "B") & (tx_ki_b46_donor['CAN_ABO'] != "B")) | 
	((tx_ki_b46_donor['DON_ABO'].isin(["A1B"])) & ~(tx_ki_b46_donor['CAN_ABO'].isin(["AB","A1B","A2B"]))) | 
	((tx_ki_b46_donor['DON_ABO'].isin(["A1"])) & ~(tx_ki_b46_donor['CAN_ABO'].isin(["A","A1","A2","A1B","A2B","AB"]))) | 
	((tx_ki_b46_donor['DON_ABO'].isin(["AB,A2B"])) & ~(tx_ki_b46_donor['CAN_ABO'].isin(["AB","A1B","A2B","B"]))) | 
	((tx_ki_b46_donor['DON_ABO'].isin(["A"])) & ~(tx_ki_b46_donor['CAN_ABO'].isin(["A","A1","A2","A1B","A2B","AB","B"]))))


# output merged HLA dataset

hla_filename = "tx_ki_hla_b46.csv"
tx_ki_b46_donor.to_csv(hla_filename, header=True, index=False)
