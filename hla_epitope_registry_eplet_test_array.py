#!/usr/bin/env python
###############################################################################
#   SCRIPT NAME:    hla_epitope_registry_eplet_test_array.py
#   DESCRIPTION:    Impute eplet matrices for SRTR matrix datasets
...
chunk_number = 0
for chunk in pd.read_csv(input_file_path, sep='\t', compression='gzip', chunksize=chunk_size):
    chunk_number += 1
