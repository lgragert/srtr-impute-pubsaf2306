#!/bin/bash
#SBATCH --job-name=hlaR_DRDQ_single_molecule_post_I10          # Job Name
#SBATCH --output=/lustre/project/lgragert/gwager/logs/hlaR_DRDQ_single_molecule_post_I10_%a.out       ### File in which to store job output
#SBATCH --error=/lustre/project/lgragert/gwager/logs/hlaR_DRDQ_single_molecule_post_I10_%a.err 
...
Rscript hlaR_DRDQ_single_molecule_post_I10.R $IMP_ID $Format_ID
