...
class AAMatch:
    ...
    def __init__(self, dbversion=3420, ungap=True):
        ...
        #end pos updated to reflect hlagenie from reference sequences
        full_end_pos = {
            "A" : 341,
            "B" : 338,
            "C" : 342,
        ...
        self.full_end_pos = full_end_pos
    ...
    def getAAposition(self, allele,position):
        #!GL!#added into function to remove DRBX since function wouldnt work in aa_mm_biopython.py
        if (allele == "DRBX*NNNN"):
            return '-'
        position -= 1
        try:
