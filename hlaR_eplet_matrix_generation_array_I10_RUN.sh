#!/bin/bash
#SBATCH --job-name=hlaR_eplet_matrix_generation_array_I10          # Job Name
#SBATCH --output=/lustre/project/lgragert/gwager/logs/hlaR_eplet_matrix_generation_I10_%a.out       ### File in which to store job output
#SBATCH --error=/lustre/project/lgragert/gwager/logs/hlaR_eplet_matrix_generation_I10_%a.err 
...
Rscript hlaR_eplet_matrix_generation_array_I10.R $IMP_ID $Format_ID
