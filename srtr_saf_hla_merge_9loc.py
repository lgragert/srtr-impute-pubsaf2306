...
tx_ki_all_hla['DON_A1'] = tx_ki_all_hla['DON_A1'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['DON_A2'] = tx_ki_all_hla['DON_A2'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['DON_B1'] = tx_ki_all_hla['DON_B1'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['DON_B2'] = tx_ki_all_hla['DON_B2'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['DON_C1'] = tx_ki_all_hla['DON_C1'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['DON_C2'] = tx_ki_all_hla['DON_C2'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['DON_DR1'] = tx_ki_all_hla['DON_DR1'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['DON_DR2'] = tx_ki_all_hla['DON_DR2'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['DON_DQ1'] = tx_ki_all_hla['DON_DQ1'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['DON_DQ2'] = tx_ki_all_hla['DON_DQ2'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')


tx_ki_all_hla['REC_A1'] = tx_ki_all_hla['REC_A1'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['REC_A2'] = tx_ki_all_hla['REC_A2'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['REC_B1'] = tx_ki_all_hla['REC_B1'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['REC_B2'] = tx_ki_all_hla['REC_B2'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['REC_CW1'] = tx_ki_all_hla['REC_CW1'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['REC_CW2'] = tx_ki_all_hla['REC_CW2'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['REC_DR1'] = tx_ki_all_hla['REC_DR1'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['REC_DR2'] = tx_ki_all_hla['REC_DR2'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['REC_DQW1'] = tx_ki_all_hla['REC_DQW1'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
tx_ki_all_hla['REC_DQW2'] = tx_ki_all_hla['REC_DQW2'].str.replace(r'^(\d\d)(\d\d)$',r'\1:\2')
